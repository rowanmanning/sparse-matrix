...
const SparseMatrix = module.exports = class SparseMatrix {
	...
	static _applyDefaultOptions(options) {
		...
		assertIsPlainObject(options.defaultData, 'The defaultData option must be a plain object');
		assertIsPositiveInteger(options.rowCount, 'The rowCount option must be a positive integer');
		assertIsPositiveInteger(options.columnCount, 'The columnCount option must be a positive integer');
		return options;
	}
